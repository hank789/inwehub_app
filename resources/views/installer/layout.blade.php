...
<div class="header text-center">
  <h1>
    <a href="http://www.inwehub.com" class="logo">
...
<footer class="main-footer text-center">
  <strong>Copyright © 2010-{{ date("Y-m-d") }} <a href="http://www.inwehub.com" target="_blank">tipask.com</a>.</strong> All rights reserved.
</footer>
