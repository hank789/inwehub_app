                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group-xs" >
                                                    <a class="btn btn-default" target="_blank" href="{{ route('ask.answer.detail',['question_id'=>$answer->question_id,'id'=>$answer->id]) }}" data-toggle="tooltip" title="查看"><i class="fa fa-eye"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="text-right">
                                    ...
                                    {!! str_replace('/?', '?', $answers->appends($filter)->render()) !!}
                                </div>
                            </div>
                        </div>
                    </div>
