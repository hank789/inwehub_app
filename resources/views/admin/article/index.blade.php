                        ...
                        <div class="row">
                            <div class="col-xs-2">
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-default btn-sm" data-toggle="tooltip" title="设为精选" onclick="confirm_submit('item_form','{{  route('admin.article.verify_recommend') }}','确认将选中项设为精选推荐项？')"><i class="fa fa-heart"></i></button>
                                    ...
                                    <form name="searchForm" action="{{ route('admin.article.index') }}" method="GET">
                                        ...
                                        <div class="col-xs-2">
                                            <select class="form-control" name="category_id">
                                                ...
                                                @include('admin.category.option',['type'=>'articles','select_id'=>$filter['category_id'],'root'=>false])
                                            </select>
                                        </div>
                                        <div class="col-xs-2">
