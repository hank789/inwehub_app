                ...
                <div class="info-box">
                    <a href="{{ route('admin.user.index') }}">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{ $totalUserNum }}
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <a href="{{ route('admin.user.index') }}">
                        <span class="info-box-icon bg-aqua"><i class="fa fa-users" aria-hidden="true"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">手机用户数</span>
                            <span class="info-box-number">{{ $totalUserNumHasPhone }}
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <a href="{{ route('admin.user.index') }}">
                        <span class="info-box-icon bg-aqua"><i class="fa fa-users" aria-hidden="true"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">邮箱用户数</span>
                            <span class="info-box-number">{{ $totalUserNumHasEmail }}
