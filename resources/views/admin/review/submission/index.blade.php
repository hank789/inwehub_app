                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach($submissions as $submission)
                                        <tr id="submission_{{ $submission->id }}">
                                            <td>{{ $submission->id }}</td>
                                            <td>
                                                <a href="{{ config('app.mobile_url').'#/dianping/comment/'.$submission->slug }}" target="_blank">{{ str_limit(strip_tags($submission->title)) }}</a>
                                                ...
                                                <div class="btn-group-xs" >
                                                    ...
                                                    <a class="btn btn-default" target="_blank" href="{{ route('admin.review.submission.addOfficialReply',['id'=>$submission->id]) }}" data-toggle="tooltip" title="官方回复"><i class="fa fa-comment-o"></i></a>
