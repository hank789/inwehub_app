                    ...
                    <form role="form" name="addForm" method="POST" enctype="multipart/form-data" action="{{ route('admin.operate.recommendQa.store') }}">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_avatar_url" class="form-control "  placeholder="http://intervapp-test.oss-cn-zhangjiakou.aliyuncs.com/media/16/user_origin_10.jpg" value="{{ old('user_avatar_url','') }}">
                            </div>
                            <div class="form-group">
                                <label>问题价格</label>
