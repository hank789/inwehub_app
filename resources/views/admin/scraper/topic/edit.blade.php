                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_base">
                            <form id="article_form" method="POST" role="form" enctype="multipart/form-data" action="{{ route('admin.scraper.topic.update',['id'=>$article->id]) }}">
                        ...
                        <div class="tab-pane" id="tab_news">
                            <form role="form" name="newsForm" method="POST" action="{{ route('admin.scraper.topic.news.update',['id'=>$article->id]) }}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            var table = $('#topic_news_table').DataTable({
                ...
                "stateSave": true,
                "ajax": {
                    "url" : "{{ route('admin.scraper.topic.loadnews',['id'=>$article->id]) }}",
                    "type": "POST",
                    "data": function ( d ) {
