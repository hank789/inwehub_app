...
<div class="bg-card">
    <div class="component-qrcode">
        <div class="circle"></div><img class="qrcode" src="{{$demand['qrcodeUrl']}}">
    </div>
