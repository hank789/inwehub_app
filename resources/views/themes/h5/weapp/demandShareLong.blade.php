...
<div class="component-card">
    ...
    <div class="labels">
        ...
        <div class="label">需{{$demand['project_cycle']['text']}}</div>
        <div class="label">{{$demand['industry']['text']}}</div>
    </div>
    <div class="cardLine"></div>
    <div class="cardfooter">
        <div class="address"><img src="images/position@3x.png"><span>{{$demand['address']['selProvince']  === '请选择' ? '' : $demand['address']['selProvince'] }}{{$demand['address']['selCity'] ? $demand['address']['selCity'] : ''}}{{$demand['address']['selDistrict'] ? $demand['address']['selDistrict'] : ''}}</span></div>
        <div class="price"><span class="number">{{$demand['salary']}}</span><span class="unit">元/{{$demand['salary_type'] == 1?'天':'月'}}</span></div>
    </div>
    <div class="cardTriangle"></div>
</div>
<div class="component-qrcode"><img class="qrcode" src="images/qrcode@3x.png"><img class="center" src="{{ $demand['qrcodeUrl'] }}"></div>
<div class="component-qrcode-help"><img src="images/zhiwen@3x.png"><span>长按识别小程序，查看项目招募信息</span></div>
