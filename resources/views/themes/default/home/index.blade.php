...
@section('jumbotron')
    ...
    <div class="jumbotron text-center">
        <h4>{{ Setting()->get('website_welcome','现在加入樱维社区') }} <a class="btn btn-primary ml-10" href="{{ route('auth.user.register') }}" role="button">立即注册</a> <a class="btn btn-default ml-5" href="{{ route('auth.user.login') }}" role="button">用户登录</a></h4>
    </div>
    @endif
@endsection
