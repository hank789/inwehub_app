    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td class="content-block">
                <div style=" width: 720px; height: 100%; padding: 20px 30px 34px; ">
                    ...
                    <div style="width: 720px;height: 2px; background: #03AEF9; margin-top: 21px;"></div>
                    ...
                    <div class="" style="margin-top: 10px;">
                        @foreach($items as $item)
                            <div style="position: relative; height: 111px; margin: 20px 0; ">
                                ...
                                @endif
                                <div style="position: absolute; bottom: 0px; left: 33px; width: 688px; height: 2px; background: #E0E8EF;"></div>
                            </div>
                        @endforeach

                        <div style="display:none; text-align: center; color: #B3C2D5; font-size: 16px; font-family:PingFangSC-Medium; font-weight:500;">查看更多</div>
