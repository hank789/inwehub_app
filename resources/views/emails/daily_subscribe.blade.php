    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td class="content-block">
                <div style="width: 658px; height: 100%; padding: 20px 30px 34px; ">
                        ...
                        @foreach($items as $key=>$item)
                            <div style="position: relative; height: 111px; margin: 20px 0; ">
                                <div style="position: absolute; left: 0; height: 90px; width: 100%;">
                                    <span style="color: #7C93B2; font-size: 18px; font-family:PingFangSC-Medium; font-weight:500; ">{{ $key+1 }}.</span>
                                    <a target="_blank" href="{{ $item['link_url'] }}" style="text-decoration:none; color: #4A5F7B; font-size: 18px; font-family:PingFangSC-Medium; font-weight:500; line-height:28px; {{ $item['img']?'width: 400px;':'' }} position: absolute; top: 0; left: 31px; display:-webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; overflow: hidden;">{{ $item['title'] }}</a>
                                ...
                                @if ($item['img'])
                                    <div style=" position: absolute; right: 0; width: 132px; height: 89px; border-radius: 4px;"><img style=" width: 100%;height: 100%; border-radius: 4px;" src="{{ $item['img'] }}" alt=""></div>
                                @endif
