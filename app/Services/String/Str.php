...
use ArrayAccess;
use App\Services\String\Exceptions\ErrorCreatingStringException;
use App\Services\String\Exceptions\UnknownFunctionException;
use App\Services\String\Exceptions\UnsetOffsetException;
use App\Services\String\Integrations\Underscore;
 ...
 *
 * @method \App\Services\String\Str accord($count, $many, $one, $zero = null)
 * @method \App\Services\String\Str random($length = 16)
 * @method \App\Services\String\Str quickRandom($length = 16)
 ...
 * @method \App\Services\String\Str sliceFrom($slice)
 * @method \App\Services\String\Str sliceTo($slice)
 * @method \App\Services\String\Str baseClass()
 * @method \App\Services\String\Str prepend($with)
 * @method \App\Services\String\Str append($with)
 * @method \App\Services\String\Str limit($limit = 100, $end = '...')
 * @method \App\Services\String\Str remove($remove)
 * @method \App\Services\String\Str replace($replace, $with)
 * @method \App\Services\String\Str toggle($first, $second, $loose = false)
 * @method \App\Services\String\Str slugify($separator = '-')
 * @method array explode($with, $limit = null)
 * @method \App\Services\String\Str lower()
 * @method \App\Services\String\Str plural()
 * @method \App\Services\String\Str singular()
 * @method \App\Services\String\Str upper()
 * @method \App\Services\String\Str title()
 * @method \App\Services\String\Str words($words = 100, $end = '...')
 * @method \App\Services\String\Str toPascalCase()
 * @method \App\Services\String\Str toSnakeCase()
 * @method \App\Services\String\Str toCamelCase()
 */
class Str implements ArrayAccess
{
     ...
     *
     * @return mixed|\App\Services\String\Str
     */
