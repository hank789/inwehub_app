...
class ProfileController extends Controller
{
    ...
    public function info(Request $request)
    {
        ...
        $info['newbie_unfinish_tasks']= ['readhub_comment'=>true,'ask'=>true,'complete_userinfo'=>true];
        ...
        if ($newbie_complete_userinfo_task) {
            $info['newbie_unfinish_tasks']['complete_userinfo'] = false;
        }
