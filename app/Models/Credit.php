...
class Credit extends Model
{
    ...
    public static $creditSetting = [
        ...
        self::KEY_READHUB_SUBMISSION_UPVOTE => ['backend_label'=>'动态分享被点赞','notice_user'=>'点赞成功'],
        self::KEY_READHUB_SUBMISSION_COLLECT => ['backend_label'=>'动态分享被收藏','notice_user'=>'收藏成功'],
        self::KEY_READHUB_SUBMISSION_SHARE => ['backend_label'=>'动态分享被转发','notice_user'=>'转发成功'],
        self::KEY_PAY_FOR_VIEW_ANSWER => ['backend_label'=>'付费围观答案(提问者加分)','notice_user'=>'付费围观成功'],
        self::KEY_ANSWER_UPVOTE => ['backend_label'=>'专业回答被点赞','notice_user'=>'点赞成功'],
        self::KEY_ANSWER_COMMENT => ['backend_label'=>'回复专业回答','notice_user'=>'回复成功'],
        ...
        self::KEY_COMMUNITY_ANSWER_INVITED => ['backend_label'=>'邀请互动回答（回答后邀请者加分）','notice_user'=>'回答成功'],
