 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Readhub\SubmissionDownvotes whereIpAddress($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Readhub\SubmissionDownvotes whereSubmissionId($value)
 */
class SubmissionDownvotes extends Model {

    protected $table = 'submission_downvotes';
